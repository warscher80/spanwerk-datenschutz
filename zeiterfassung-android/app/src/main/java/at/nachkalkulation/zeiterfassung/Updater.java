...
/**
 * Prueft beim Start, ob online eine neuere Version bereitsteht, laedt diese
...
class Updater {
    ...
    private static final String VERSION_URL =
            "https://warscher80.github.io/spanwerk-datenschutz/zeiterfassung-version.json";
    ...
    private void promptUpdate(String name, String url, String notes) {
        String msg = "Version " + name + " ist verfuegbar.";
        if (notes != null && !notes.isEmpty()) msg += "\n\n" + notes;
        new AlertDialog.Builder(activity)
                .setTitle("Update verfuegbar")
                .setMessage(msg)
    ...
    private void startUpdate(String url) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O
            ...
            Toast.makeText(activity,
                    "Bitte Installation fuer diese App erlauben, dann erneut auf Aktualisieren tippen.",
    ...
    private void download(String url) {
        ...
        req.setTitle("Zeiterfassung-Update");
